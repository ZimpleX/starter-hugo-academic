...
I am a Research Scientist at Meta AI, where I work on SoTA LLMs and graph learning models for web-scale social recommendation. Prior to Meta, I obtained my Ph.D. in Computer Engineering at University of Southern California, advised by Prof. [Viktor Prasanna](https://sites.usc.edu/prasanna/). My thesis focused on improving the scalability, accuracy and efficiency of large scale Graph Neural Networks. I designed new neural network models, learning algorithms as well as hardware systems for scalable training and inference. My work has led to publications in top venues in both AI (ICLR, NeurIPS, ICML, etc.) and systems (FPGA, VLDB, TRETS, etc.). I have received outstanding / top reviewer awards from ICLR, NeurIPS and ICML. 
